...
.top-header span {
    font-family: 'Myriad Pro-Bold', 'DejaVu Sans Condensed',
    Helvetica, Arial, sans-serif;
    font-weight: bold;
    font-size: 60px;
    color: #FFFFFF;
}
.top-header span a i:hover{ text-decoration:none !important; color:#337ab7 !important;}
.top-header span a:hover{text-decoration:none !important;}

</style>
<div class="top-header">
	<span><a href="#"><i>fitbitty</i></a></span>
	</p>
</div>
