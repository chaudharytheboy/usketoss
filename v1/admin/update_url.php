...
if(isset($_POST['idfrom'])  && isset($_POST['idTo']))
{
  ...
  $_POST['proImagefrom'] = str_replace('images/',"",$_POST['proImagefrom']);
  $_POST['proImage1from'] = str_replace('images/',"",$_POST['proImage1from']);
  $regulartextFrom = trim($_POST['regulartextfrom']);
  
  $offerTo = trim($_POST['offerTo']); 
  $offer1To = trim($_POST['offer1To']); 
  $_POST['proImageTo'] = str_replace('images/',"",$_POST['proImageTo']);
  $_POST['proImage1To'] = str_replace('images/',"",$_POST['proImage1To']);
