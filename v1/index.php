    ...
    <article id="post-7" class="post-7 page type-page status-publish hentry">
      ...
      <div class="page-content">
        ...
        <p><header id="top" class="fn">
          <div>
              <?php
                $products = mysqli_query($conn, "SELECT * FROM products WHERE url_1 = 'http://fitbitty.com/usketoss/v1/'");
                if($products)
                {
                                                  ...
                                                  <div>
                                                    ...
                                                    {                                               
                                                      ...
                                                      <div style="text-align: center;">
                                                        <a id="<?php echo $data['tracking_link']; ?>" target="_top" rel="noopener noreferrer" class="remove_link">
                                                          <img src="images/<?php echo $data['images'];?>" class="img-responsive rev" style="max-height: 300px; max-width: 300px;">
                                                        </a>
                                                      </div>
                                                    </div>
    ...
    while($data = mysqli_fetch_array($products,MYSQLI_BOTH)){
      ...
      <div class="col-sm-4">
        ...
        {                                               
          ?>
          <a id="<?php echo $data['tracking_link'];?>" target="_top" rel="noopener noreferrer" class="remove_link">
            <img src="images/<?php echo $data['images1'];?>" class="img-responsive rev" style="max-height: 300px; max-width: 300px;">
          </a>
        </div>
