...
$(document).on('click', '.swap', function() {
    ...
    $.ajax({
        url: baseURL + "/usasurveyz/admin/update_url.php",
        type: "post",
        data: postDat,
        dataType: "json",
...
$(document).on('click','.removePic',function(){
    ...
    $.ajax({
        ...
        success: function(jsonResponse) {
            if (jsonResponse.status == true) {   
                $(Obj).parent().parent('tr').find('.images').find('img').attr('src','https://usasurveyz.com/usasurveyz/images/products_image/default-product-img.jpg');                 
...
$(document).on('click', '.remove_pic',function(){
    ...
    var Obj = $(this);
       $.ajax({
        ...
        success: function(jsonResponse) {
            if (jsonResponse.status == true) {   
                $(Obj).parent().parent('tr').find('.img_popular').find('img').attr('src','https://usasurveyz.com/usasurveyz/images/popular_image/default-product-img.jpg');                 
                $(Obj).parent().find('a').remove();
            }
        },
        error: function(jsonResponse) {
